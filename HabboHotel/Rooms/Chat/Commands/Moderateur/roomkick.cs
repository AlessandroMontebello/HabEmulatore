...
namespace Akiled.HabboHotel.Rooms.Chat.Commands.Cmd
{
    class roomkick : IChatCommand
    {
        public void Execute(GameClient Session, Room Room, RoomUser UserRoom, string[] Params)
        {
            ...
            {
                AkiledEnvironment.GetGame().GetClientManager().StaffAlert(RoomNotificationComposer.SendBubble("publicidad", "L'utente: " + Session.GetHabbo().Username + ", Pub CMD:" + MessageAlert + ", Clicca qui per andare a vedere.", "event:navigator/goto/" + Session.GetHabbo().CurrentRoomId));
                return;
            }
