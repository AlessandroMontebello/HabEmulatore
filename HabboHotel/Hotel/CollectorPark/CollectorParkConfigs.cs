                ...
                if (!string.IsNullOrEmpty(key))
                {
                    if (key.Split(',').Length == 2)
                    {
                        ...
                        if (checkMin > 0 && checkMax > 0)
                        {
                            ...
                            client.SendWhisper("Hia vinto " + amount + " crediti nel Collector Park!");
                        }
                    }
                    else
                    {
                ...
                if (!string.IsNullOrEmpty(key))
                {
                    if (key.Split(',').Length == 2)
                    {
                        ...
                        if (checkMin > 0 && checkMax > 0)
                        {
                            ...
                            client.SendWhisper("Hai vinto " + amount + "Smeraldi nel Parco del Collezionista!");
                        }
                    }
                    else
                    {
                ...
                if (!string.IsNullOrEmpty(key))
                {
                    if (key.Split(',').Length == 2)
                    {
                        ...
                        if (checkMin > 0 && checkMax > 0)
                        {
                            ...
                            client.SendWhisper("Hai vinto " + amount + " diamanti in Collector Park!");
                        }
                    }
                    else
                    {
