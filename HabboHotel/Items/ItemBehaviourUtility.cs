                ...
                case InteractionType.EXTRABOX:
                    {
                        ...
                        Message.WriteString("Congratulazioni, hai ricevuto una RareBox! Aprilo per scoprire il tuo premio");
                ...
                case InteractionType.DELUXEBOX:
                    {
                        ...
                        Message.WriteInteger(4);
                        Message.WriteString("MESSAGE");
                        Message.WriteString("Congratulazioni, hai ricevuto una RareBox Deluxe! Aprilo per scoprire il tuo premio");
                        Message.WriteString("PURCHASER_NAME");
                        Message.WriteString("Akiled");
                        Message.WriteString("PRODUCT_CODE");
                        Message.WriteString("A1 KUMIANKKA");
                ...
                case InteractionType.LEGENDBOX:
                    {
                        ...
                        Message.WriteInteger(4);
                        Message.WriteString("MESSAGE");
                        Message.WriteString("Congratulazioni, hai ricevuto una RareBox! Leggendario Aprilo per scoprire il tuo premio");
                        Message.WriteString("PURCHASER_NAME");
                        Message.WriteString("Akiled");
                        Message.WriteString("PRODUCT_CODE");
                        Message.WriteString("A1 KUMIANKKA");
