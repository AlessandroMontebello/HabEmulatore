        ...
        public override void OnTrigger(GameClient Session, Item Item, int Request, bool UserHasRights)
        {
            ...
            try
            {
                if (Item.ExtradataInt >= Item.GetBaseItem().Modes)
                {
                    ...
                    Session.SendWhisper("Belle abilità! Sei riuscito ad aprire con successo la scatola.", 1);
                ...
                else
                {
                    ...
                    Session.SendWhisper("Fai clic sul'altro " + num.ToString() + " per rompere la scatola!", 1);
                }
            }
            catch (Exception ex)
            {
